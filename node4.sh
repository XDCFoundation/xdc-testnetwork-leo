...
${PROJECT_DIR}/build/bin/$Bin_NAME --bootnodes "enode://47af697380c1eb76bdc04f5b1f1f6aff24da552f52f769055e8a51e573d38bba96d1144a7d51a00db76666fe502b148aa1d1c7344d3a9a4776fc0d88f2b5cd2c@54.163.43.173:30301" --syncmode "full" --datadir ./nodes/4 --networkid "${networkid}" --port 30306 --rpc --rpccorsdomain "*" --rpcaddr 0.0.0.0 --ws --wsaddr="0.0.0.0" --wsorigins "*" --wsport 8558 --rpcport 8548 --rpcvhosts "*" --unlock "${wallet4}" --password ./.pwd --mine --gasprice "1" --targetgaslimit "420000000" --verbosity 3 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,XDPoS --ethstats "Leo-Node-04:xinfin_xdpos_hybrid_network_stats@stats.xinfin.network:3000" 2>XDC_node4.log &
